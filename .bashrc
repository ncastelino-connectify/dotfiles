...
#"[\e[32;1m\]\u@rhinestone \[\e[0m\]\w]\$ " if [$EUID == 0] else echo "nono"

export PERL_LOCAL_LIB_ROOT="/home/neil/perl5";
export PERL_MB_OPT="--install_base /home/neil/perl5";
...
alias pick='sudo apt search'
alias update='sudo apt update'
alias upgrade='sudo apt upgrade && sudo bash -c "echo 0 > /dev/shm/apt.stat"'
alias vpn='sudo openconnect vpn.drexel.edu --authgroup=DrexelVPN'
